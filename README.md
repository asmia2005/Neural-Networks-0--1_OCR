...
This was a workshop conducted under IEEE SIES GST, Focuses on understanding the core principles of Machine Learning. Here we covered from basic Math used in computing a neuron to classifying 10 digit numbers using a fully cnnected Neural Network.
